        ...
        <div class="dadosProduto">
            ...
            <div class="campos">
                <div class="campo">
                    ...
                    <div class="valor">
                        <g:select name="categorias" from="${CategoriaProduto.list()}" multiple="multiple" optionKey="id" optionValue="nome" size="5" value="${produtoInstance?.categorias}" class="many-to-many"/>
                    </div>
                </div>
            </div>
