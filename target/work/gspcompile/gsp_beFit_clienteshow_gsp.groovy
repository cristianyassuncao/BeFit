...
printHtmlPart(15)
invokeTag('render','g',36,['template':("/pessoa/detalhes"),'model':(['pessoaInstance': clienteInstance?.pessoa, 'somenteLeitura': true])],-1)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(16)
createTagBody(3, {->
...
invokeTag('link','g',39,['class':("edit"),'action':("edit"),'resource':(clienteInstance)],3)
printHtmlPart(17)
...
invokeTag('form','g',42,['url':([resource:clienteInstance, action:'delete']),'method':("DELETE")],2)
printHtmlPart(19)
})
...
public static final long LAST_MODIFIED = 1431901580756L
