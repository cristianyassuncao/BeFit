...
class gsp_befit_itemDiashow_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/itemDia/show.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(11)
invokeTag('message','g',26,['code':("itemDia.data.label")],-1)
printHtmlPart(12)
invokeTag('formatDate','g',29,['date':(itemDiaInstance?.data),'format':("dd/MM/yyyy")],-1)
printHtmlPart(13)
invokeTag('message','g',34,['code':("itemDia.produto.label")],-1)
printHtmlPart(14)
...
invokeTag('link','g',44,['class':("edit"),'action':("edit"),'resource':(itemDiaInstance)],3)
printHtmlPart(17)
...
invokeTag('form','g',47,['url':([resource:itemDiaInstance, action:'delete']),'method':("DELETE")],2)
printHtmlPart(19)
})
...
public static final long LAST_MODIFIED = 1441882706285L
