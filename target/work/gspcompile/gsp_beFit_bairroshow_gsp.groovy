...
class gsp_beFit_bairroshow_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/bairro/show.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(12)
invokeTag('message','g',26,['code':("bairro.id.label")],-1)
printHtmlPart(13)
invokeTag('fieldValue','g',29,['bean':(bairroInstance),'field':("id")],-1)
printHtmlPart(14)
invokeTag('message','g',36,['code':("bairro.nome.label")],-1)
printHtmlPart(13)
invokeTag('fieldValue','g',39,['bean':(bairroInstance),'field':("nome")],-1)
printHtmlPart(14)
invokeTag('message','g',46,['code':("bairro.cidade.label")],-1)
printHtmlPart(13)
...
invokeTag('link','g',56,['class':("edit"),'action':("edit"),'resource':(bairroInstance)],3)
printHtmlPart(17)
...
invokeTag('form','g',59,['url':([resource:bairroInstance, action:'delete']),'method':("DELETE")],2)
printHtmlPart(19)
})
...
public static final long LAST_MODIFIED = 1437615270867L
