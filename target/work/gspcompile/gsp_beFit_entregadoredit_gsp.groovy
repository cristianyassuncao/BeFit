...
class gsp_befit_entregadoredit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/entregador/edit.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('eachError','g',32,['bean':(entregadorInstance),'var':("error")],3)
printHtmlPart(20)
})
invokeTag('hasErrors','g',34,['bean':(entregadorInstance)],2)
printHtmlPart(13)
createTagBody(2, {->
printHtmlPart(21)
invokeTag('hiddenField','g',36,['name':("id"),'value':(entregadorInstance?.id)],-1)
printHtmlPart(22)
invokeTag('render','g',38,['template':("/pessoa/dadosPrincipaisPF"),'model':(['pessoaInstance': entregadorInstance?.pessoa])],-1)
printHtmlPart(23)
invokeTag('render','g',39,['template':("form")],-1)
printHtmlPart(24)
invokeTag('render','g',40,['template':("/pessoa/detalhes"),'model':(['pessoaInstance': entregadorInstance?.pessoa])],-1)
printHtmlPart(25)
invokeTag('actionSubmit','g',43,['class':("save"),'action':("update"),'value':(message(code: 'default.button.update.label', default: 'Update'))],-1)
printHtmlPart(23)
createTagBody(3, {->
printHtmlPart(26)
invokeTag('message','g',45,['code':("treal.botaoCancelar"),'default':("Cancelar")],-1)
printHtmlPart(23)
})
invokeTag('link','g',46,['class':("cancel"),'controller':("entregador"),'action':("index")],3)
printHtmlPart(27)
})
invokeTag('form','g',48,['url':([action:'update'])],2)
printHtmlPart(28)
})
...
public static final long LAST_MODIFIED = 1441887811029L
