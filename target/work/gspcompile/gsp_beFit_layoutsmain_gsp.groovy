...
printHtmlPart(7)
invokeTag('javascript','g',18,['src':("jquery-2.1.3.js")],-1)
printHtmlPart(3)
invokeTag('javascript','g',19,['src':("jquery-ui-1.11.3.custom/jquery-ui.js")],-1)
printHtmlPart(3)
invokeTag('javascript','g',20,['src':("jquery.maskedinput.js")],-1)
printHtmlPart(1)
invokeTag('javascript','g',21,['src':("chosen_v1.4.2/chosen.jquery.js")],-1)
printHtmlPart(3)
...
createTagBody(1, {->
printHtmlPart(9)
invokeTag('image','asset',27,['src':("BeFitLogo.png"),'alt':("BeFit")],-1)
printHtmlPart(10)
createTagBody(2, {->
printHtmlPart(11)
invokeTag('principal','shiro',31,['property':("username")],-1)
printHtmlPart(12)
})
invokeTag('authenticated','shiro',34,[:],2)
printHtmlPart(13)
createClosureForHtmlPart(14, 2)
invokeTag('notAuthenticated','shiro',41,[:],2)
printHtmlPart(15)
createTagBody(2, {->
printHtmlPart(16)
...
invokeTag('authenticated','shiro',73,[:],2)
printHtmlPart(3)
invokeTag('layoutBody','g',74,[:],-1)
printHtmlPart(24)
invokeTag('message','g',75,['code':("spinner.alt"),'default':("Loading&hellip;")],-1)
printHtmlPart(25)
})
...
public static final long LAST_MODIFIED = 1443833755879L
