...
class gsp_befit_pedidoshow_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/pedido/show.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(2, {->
printHtmlPart(15)
invokeTag('render','g',25,['template':("form"),'model':([readOnly: true])],-1)
printHtmlPart(16)
createTagBody(3, {->
invokeTag('message','g',27,['code':("default.button.edit.label"),'default':("Edit")],-1)
})
invokeTag('link','g',27,['class':("edit"),'action':("edit"),'id':(pedido?.id)],3)
printHtmlPart(17)
...
invokeTag('form','g',30,['url':([resource:pedido, action:'delete']),'method':("DELETE")],2)
printHtmlPart(19)
})
...
public static final long LAST_MODIFIED = 1439385685450L
