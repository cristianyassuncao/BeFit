...
invokeTag('link','g',112,['action':("show"),'id':(pedidoInstance.id)],3)
printHtmlPart(41)
createTagBody(3, {->
expressionOut.print(pedidoInstance?.cliente?.nome)
})
invokeTag('link','g',114,['target':("_blank"),'controller':("cliente"),'action':("show"),'id':(pedidoInstance?.cliente?.id)],3)
printHtmlPart(42)
invokeTag('formatDate','g',116,['date':(pedidoInstance.dataEntrega),'format':("dd/MM/yyyy")],-1)
printHtmlPart(42)
expressionOut.print(pedidoInstance?.entregador?.nome)
printHtmlPart(42)
expressionOut.print(pedidoInstance?.endereco?.bairro?.nome)
printHtmlPart(43)
invokeTag('formatDate','g',122,['date':(pedidoInstance?.entregarAPartirDaHora),'format':("HH:mm")],-1)
printHtmlPart(42)
invokeTag('formatDate','g',124,['date':(pedidoInstance?.entregarAteHora),'format':("HH:mm")],-1)
printHtmlPart(42)
invokeTag('formatNumber','g',126,['number':(pedidoInstance?.valorAPagar),'format':("###,##0.00")],-1)
printHtmlPart(41)
invokeTag('formatNumber','g',128,['number':(pedidoInstance?.trocoPara),'format':("###,##0.00")],-1)
printHtmlPart(41)
invokeTag('formatNumber','g',130,['number':(pedidoInstance?.valorTroco),'format':("###,##0.00")],-1)
printHtmlPart(41)
invokeTag('formatNumber','g',132,['number':(pedidoInstance?.valorPago),'format':("###,##0.00")],-1)
printHtmlPart(42)
...
printHtmlPart(46)
invokeTag('paginate','g',145,['total':(pedidoInstanceTotal ?: 0),'max':("30")],-1)
printHtmlPart(47)
})
...
public static final long LAST_MODIFIED = 1441891734438L
