...
class gsp_beFit_itemDiacreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/itemDia/create.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('eachError','g',25,['bean':(itemDiaInstance),'var':("error")],3)
printHtmlPart(17)
})
invokeTag('hasErrors','g',27,['bean':(itemDiaInstance)],2)
printHtmlPart(10)
createTagBody(2, {->
printHtmlPart(18)
...
invokeTag('form','g',35,['url':([resource:itemDiaInstance, action:'save'])],2)
printHtmlPart(21)
})
...
public static final long LAST_MODIFIED = 1441806457893L
