...
printHtmlPart(5)
invokeTag('select','g',32,['name':("categorias"),'from':(CategoriaProduto.list()),'multiple':("multiple"),'optionKey':("id"),'optionValue':("nome"),'size':("5"),'value':(produtoInstance?.categorias*.id),'class':("many-to-many")],-1)
printHtmlPart(6)
...
public static final long LAST_MODIFIED = 1433680759336L
