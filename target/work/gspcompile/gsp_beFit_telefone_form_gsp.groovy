...
printHtmlPart(6)
invokeTag('select','g',29,['id':("tipoTelefone"),'name':("tipoTelefone.id"),'from':(TipoTelefone.list()),'optionKey':("id"),'optionValue':("descricao"),'noSelection':(['':'-Escolha o Tipo de Telefone-']),'value':(telefoneInstance?.tipoTelefone?.id)],-1)
printHtmlPart(7)
}
...
public static final long LAST_MODIFIED = 1433704462517L
