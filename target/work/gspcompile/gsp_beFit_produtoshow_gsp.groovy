...
printHtmlPart(15)
invokeTag('select','g',62,['name':("categorias"),'from':(CategoriaProduto.list()),'multiple':("multiple"),'optionKey':("id"),'optionValue':("nome"),'size':("5"),'value':(produtoInstance?.categorias*.id),'class':("many-to-many"),'readonly':("readonly")],-1)
printHtmlPart(17)
...
public static final long LAST_MODIFIED = 1433681347036L
